...
(function ($, CONFIG) {
    ...
    function searchItem (icon, title, slug, preview, url) {
        return $('<div>').addClass('ins-selectable').addClass('ins-search-item')
            .append($('<header>').append($('<i>').addClass('fa').addClass('fa-' + icon).addClass('ins-icon')).append(title != null && title != '' ? title : CONFIG.TRANSLATION['UNTITLED'])
